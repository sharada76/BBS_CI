  ...
  <div class="container mt-4">
    <div class="border p-4">
      ...
      <form class="mb-4 border-top p-4" method="POST" action=<?php echo site_url('posts/comments/store/' . $post_item['id']); ?>>
        ...
        <input id="id" name="id" type="hidden" value="<?php echo $post_item['id']; ?>">
        <h2 class="h5 mb-4">
          コメント
        </h2>
          ...
          : foreach ($comments as $comment) : ?>
            <div class="border-top p-4">
              ...
              <?php if ($_SESSION['name'] ===  $comment['name']) : ?>
                <div class="mb-4 text-right">
                  <form style="display: inline-block;" method="POST" action=<?php echo site_url('posts/comments/delete/' . $comment['id']); ?>>
