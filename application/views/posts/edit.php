      ...
      <form method="POST" action=<?php echo site_url('posts/update/' . $post_item['id']); ?>>
        ...
        <fieldset class="mb-4">
          <div class="form-group">
            ...
            <input id="title" name="title" class="form-control" value="<?php echo $post_item['title']; ?>" type="text">
          ...
          <div class="form-group">
            ...
            <textarea id="content" name="content" class="form-control" rows="4"><?php echo $post_item['content']; ?></textarea>
